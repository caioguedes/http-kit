...
/**
 * @author feng <shenedu@gmail.com> 2014/1/1
 */
public class MultipartEntity {
  ...
  public static ByteBuffer encode(
      String boundary, List<MultipartEntity> entities, Boolean multipartMixed) throws IOException {
