...
public class HttpServer implements Runnable {
  ...
  public static final ContextLogger<String, Throwable> DEFAULT_WARN_LOGGER =
      ...
      do {
        ...
        if (request != null) {
          ...
          AsyncChannel channel =
              atta.channel.isClosed() ? new AsyncChannel(key, this) : atta.channel;
      ...
      do {
        ...
        try {
          for (SelectionKey k : selector.keys()) {
            /**
             * 1. t.toArray will fill null if given array is larger. 2. compute t.size(), then try
             * to fill the array, if in the mean time, another thread close one SelectionKey, will
             * result a NPE
             *
             * <p>https://github.com/http-kit/http-kit/issues/125
             */
            if (k != null) closeKey(k, 0); // 0 => close by server
          }
           ...
           *
           * <p>https://github.com/http-kit/http-kit/issues/355
           */
          cmex = true;
        }
      } while (cmex);
