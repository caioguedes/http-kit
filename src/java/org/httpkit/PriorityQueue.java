...
/**
 * Copy and modified from java.util.PriorityQueue. Remove unused method. Modify {@code remove} to
 * return the removed element
 *
 * <p>used by timer and the client
 *
 * @param <E>
 */
...
public class PriorityQueue<E> {
   ...
   *
   * <p>the initial capacity for this priority queue
   *
