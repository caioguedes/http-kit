...
public class DynamicBytes {
  ...
  // Ref.
  // https://github.com/openjdk/jdk/blob/d5ce66698d2f15c5f8316110a6118a10baa4013d/src/java.base/share/classes/jdk/internal/util/ArraysSupport.java#L842-L854
  ...
  private void expandIfNeeded(int more) {
    ...
    if (need > SOFT_MAX_ARRAY_LENGTH) {
      throw new ContentTooLargeException(
          "Cannot expand DynamicBytes array: requested size (" + need + ") exceeds Java limits");
    }
